          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-3 font-display text-4xl italic text-ink">
                Kill guided actions immediately.
              </p>
              <p className="mt-4 text-sm leading-7 text-slate">
                Use this when a page looks wrong, a verification screen appears,
                or you want every queued action halted before any further steps.
              </p>
              <button
                type="button"
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate">
                      {session.platform} · {modeLabel(session.mode)} ·{" "}
          ...
          {attemptsQuery.data?.map((attempt) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-slate">
                  {attempt.platform} · {modeLabel(attempt.mode)} ·{" "}
