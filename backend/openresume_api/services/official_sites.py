...
OFFICIAL_SITE_DESCRIPTORS: tuple[OfficialSiteDescriptor, ...] = (
    ...
    OfficialSiteDescriptor(
        ...
        label="\u817e\u8baf\u97f3\u4e50\u5b98\u7f51",
        login_url="https://join.tencentmusic.com/login",
        session_check_url="https://join.tencentmusic.com/login",
        source_sites=("join.tencentmusic.com",),
        supported_variants=ALL_VARIANTS,
        aliases=("TME", "Tencent Music", "Tencent Music Entertainment"),
    ),
    OfficialSiteDescriptor(
        company_key="baidu",
        company_name="\u767e\u5ea6",
        label="\u767e\u5ea6\u5b98\u7f51",
        login_url="https://talent.baidu.com/",
        session_check_url="https://talent.baidu.com/",
        source_sites=("talent.baidu.com",),
        supported_variants=ALL_VARIANTS,
        aliases=("Baidu",),
    ),
    OfficialSiteDescriptor(
        ...
        company_name="\u6ef4\u6ef4",
        label="\u6ef4\u6ef4\u5b98\u7f51",
        login_url="https://talent.didiglobal.com/social/list/1",
        session_check_url="https://talent.didiglobal.com/social/list/1",
        source_sites=("talent.didiglobal.com", "campus.didiglobal.com"),
        supported_variants=ALL_VARIANTS,
        aliases=("Didi", "DiDi"),
    ),
    OfficialSiteDescriptor(
        ...
        company_name="\u643a\u7a0b",
        label="\u643a\u7a0b\u5b98\u7f51",
        login_url="https://job.ctrip.com/",
        session_check_url="https://job.ctrip.com/",
        source_sites=("job.ctrip.com",),
        supported_variants=ALL_VARIANTS,
    ...
    OfficialSiteDescriptor(
        ...
        company_name="\u7f51\u6613",
        label="\u7f51\u6613\u5b98\u7f51",
        login_url="https://hr.163.com/",
        session_check_url="https://hr.163.com/",
        source_sites=("hr.163.com", "campus.163.com"),
        supported_variants=ALL_VARIANTS,
        aliases=("NetEase", "163"),
    ),
    OfficialSiteDescriptor(
        ...
        company_name="\u5938\u514b",
        label="\u5938\u514b\u5b98\u7f51",
        login_url="https://talent.quark.cn/off-campus/home?lang=zh",
        session_check_url="https://talent.quark.cn/off-campus/home?lang=zh",
        source_sites=("talent.quark.cn",),
        supported_variants=ALL_VARIANTS,
        aliases=("Quark",),
    ),
    OfficialSiteDescriptor(
