...
VARIANT_CONFIGS: dict[str, AlibabaCareerVariantConfig] = {
    "experienced": AlibabaCareerVariantConfig(
        ...
        detail_path_template=(
            "https://talent.ele.me/off-campus/position-detail?positionId={job_id}"
        ),
    ...
    "campus": AlibabaCareerVariantConfig(
        ...
        detail_path_template=(
            "https://talent.ele.me/campus/position-detail"
...
class ElemeCareerClient(AlibabaCareerClient):
    def __init__(
        self,
        *,
