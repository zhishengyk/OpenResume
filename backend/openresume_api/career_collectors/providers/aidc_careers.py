...
VARIANT_CONFIGS: dict[str, AlibabaCareerVariantConfig] = {
    "experienced": AlibabaCareerVariantConfig(
        ...
        detail_path_template=(
            "https://aidc-jobs.alibaba.com/off-campus/position-detail?positionId={job_id}"
        ),
    ...
    "campus": AlibabaCareerVariantConfig(
        ...
        detail_path_template=(
            "https://aidc-jobs.alibaba.com/campus/position-detail"
...
class AidcCareerClient(AlibabaCareerClient):
    def __init__(
        self,
        *,
